...
import { LemonSqueezyInstance } from "@/utils/api-config";
import { CreateCheckoutDto } from "./dto/create-checkout.dto";

@Injectable()
export class CheckoutService {
  async createCheckout(createCheckoutDto: CreateCheckoutDto) {
    const response = await LemonSqueezyInstance.post("/checkouts", {
      data: {
        type: "subscriptions",
        id: "1",
        attributes: {
          ...
          urls: {
            update_payment_method:
              "https://my-store.lemonsqueezy.com/subscription/1/payment-details?expires=1666869343&signature=9985e3bf9007840aeb3951412be475abc17439c449c1af3e56e08e45e1345413",
            customer_portal:
            ...
            customer_portal_update_subscription:
              "https://my-store.lemonsqueezy.com/billing/1/update?expires=1666869343&signature=e4fabc7ee703664d644bba9e79a9cd3dd00622308b335f3c166787f0b18999f2",
          },
